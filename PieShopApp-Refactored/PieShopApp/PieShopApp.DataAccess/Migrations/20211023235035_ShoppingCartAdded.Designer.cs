...
namespace PieShopApp.DataAccess.Migrations
{
    ...
    [Migration("20211023235035_ShoppingCartAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PieShopApp.Domain.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PieShopApp.Domain.Models.Pie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PieShopApp.Domain.Models.ShoppingCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PieShopApp.Domain.Models.Pie", b =>
                {
                    b.HasOne("PieShopApp.Domain.Models.Category", "Category")
                        .WithMany("Pies")
            ...
            modelBuilder.Entity("PieShopApp.Domain.Models.ShoppingCartItem", b =>
                {
                    b.HasOne("PieShopApp.Domain.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId");
                });
